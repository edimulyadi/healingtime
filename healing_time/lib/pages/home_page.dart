      ...
      body: Column(
        ...
        children: [
          ...
          Container(
           ...
           child: AppTextlarge(text: 'Temukan'),
         ),
          SizedBox(height: 20,), 
          //tabbar 
          Container(
         ...
         margin:  const EdgeInsets.only(left: 20),
           child: Row(
             ...
             children: [
               AppTextlarge(text: "Jelajahi Sekarang",size: 20,),
               AppText(text: "Lihat Semuanya ",color: AppColors.textColor1,size: 10,),
             ],
         ...
         Container(
           ...
           child: ListView.builder(
             ...
             itemBuilder: (_,index) {
              return Container(
                margin: const EdgeInsets.only(right:20),                child: Column(
                  children: [
                    Container(
         ...
         Container(
            child: AppText(
             text: images.values.elementAt(3),
             color: AppColors.textColor2,size: 10,
             ),
         ),
        ],
      ),
